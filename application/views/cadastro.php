        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                ...
                unset($_SESSION['usuario_existe']);
                    ?> -->
                    <div class="box">
                        <form action="http://localhost/login-php-codeigniter/index/cadastra_novo" method="POST">
                            <div class="field">
                                <div class="control">
                            ...
                            <div class="field">
                                ...
                                <div class="field">
                                    <div class="control">
                                        <input type="email" name="email" class="input is-large" placeholder="Email" required="">
                                    </div>
                                </div>
                            </div>
                            <div class="field">
